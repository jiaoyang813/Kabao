...
public class MockCreditCardDataProvider{
    ...
    {
        ArrayList<Creditcard> templateCards = new ArrayList<>();
       /* templateCards.add(new Creditcard(1,"Chase Freedom", "", 1));
        templateCards.add(new Creditcard(2,"Chase Sapphire Preferred", "", 2));
        templateCards.add(new Creditcard(3,"Hyatt is just a very very very long long name to test the width", "", 3));
        templateCards.add(new Creditcard(4,"IHG", "", 4));
        templateCards.add(new Creditcard(5,"Chase Ink", "", 5));
        templateCards.add(new Creditcard(6,"Chase Freedom Unlimited", "", 6));
        templateCards.add(new Creditcard(1,"Amex Blue Cash", "", 1));
        templateCards.add(new Creditcard(2,"Amex Blue Cash Preferred", "", 2));
        templateCards.add(new Creditcard(3,"Amex Delta Gold", "", 3));
        templateCards.add(new Creditcard(4,"Amex Delta Platinum", "", 4));
        templateCards.add(new Creditcard(5,"SPG", "", 5));
        templateCards.add(new Creditcard(6,"Hilton", "", 6));
        templateCards.add(new Creditcard(7,"Amex Blue Cash Everyday", "", 7));
        templateCards.add(new Creditcard(8,"Amex Blue Cash Everyday Preferred", "", 8));*/
